...
const Hero = () => {
  return (
    <>
      <div className="relative bg-white pb-[110px] pt-[120px] dark:bg-dark lg:pt-[50px]">
              ...
              <div className="hero-content">
                ...
                <ul className="flex flex-wrap items-center mt-5">
                  <li>
                    <a
                      href="/#"
                      className="inline-flex items-center justify-center rounded-md bg-primary px-6 py-3 bg-blue-600 hover:bg-blue-700 text-center text-base font-medium text-white hover:bg-blue-dark lg:px-7"
                    >
                      Get Started
                    </a>
                  </li>
